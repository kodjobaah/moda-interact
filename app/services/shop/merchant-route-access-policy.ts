...
const surfaceMatrix: Record<MerchantExperienceState, readonly MerchantSurface[]> = {
  ...
  NO_CONTRACT: ["HOME", "USAGE", "BILLING_OPTIONS", "BILLING_PURCHASE_HISTORY", "SUPPORT", "PLAN_SELECT", "RECOVERY_HISTORY"],
  FROZEN: ["HOME", "USAGE", "BILLING_OPTIONS", "BILLING_PURCHASE_HISTORY", "SUPPORT", "RECOVERY_HISTORY"],
  BILLING_ATTENTION: ["HOME", "USAGE", "BILLING_OPTIONS", "BILLING_PURCHASE_HISTORY", "SUPPORT", "PLAN_SELECT", "RECOVERY_HISTORY"],
};
